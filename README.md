...
A contextual analysis of the cat/turkey isolates and 934 poultry-derived Typhimurium isolates within the same NCBI Pathogen Detection SNP cluster showed that blaCMY-2 is rare among these isolates’ immediate clonal relatives, occurring in only 12 (1.3%, Dataset 2- Typhimurium SNP context). Further, the isolates taken from the domestic cats and wild turkey fell on distal nodes of a phylogenetic tree of roughly 150 contextual poultry-derived isolates, consistent with the hypothesis of horizontal rather than vertical gene transfer (Dataset 3- Typhimurium phylogeny accessions; Figure 1- Typhimurium phylogeny).
